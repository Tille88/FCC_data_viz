...
// and https://medium.com/ninjaconcept/interactive-dynamic-force-directed-graphs-with-d3-da720c6d7811
//because... who does a force directed from scratch in D3...

//Data from https://raw.githubusercontent.com/DealPete/forceDirected/master/countries.json
...
data.nodes.forEach((el, i) => el.id = i);
...
var simulation = d3.forceSimulation()
  ...
  function ticked() {
    ...
    link
        .attr("x1", function(d) { return d.source.x /2 +width/4 ; })
        .attr("y1", function(d) { return d.source.y /2 +height/4 ; })
        .attr("x2", function(d) { return d.target.x /2 +width/4 ; })
        .attr("y2", function(d) { return d.target.y /2 +height/4 ; });

    node
        .style("left", function(d) { return (d.x/2 - 1)+(width/4) +'px' ; })
        .style("top", function(d) { return (d.y/2 + 70) +(height/4) +'px' ; });
